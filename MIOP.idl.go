...
// Struct declaration: "MIOP::UniqueId", generatedBy by: "WriteStructDcl"
...
func NewDefaultMiopUniqueId() *MiopUniqueId {
	//noinspection GoRedundantConversion
	return &MiopUniqueId{
		IdlObject: __goidl__.IdlObject{
			Id: MiopUniqueIdId_Const,
		},
...
//noinspection GoUnusedExportedFunction
func NewMiopUniqueId(
	//"StructDclAllParamsConstructorParamService"
	Array byte) *MiopUniqueId {
	//noinspection GoRedundantConversion
	return &MiopUniqueId{
		IdlObject: __goidl__.IdlObject{
			Id: MiopUniqueIdId_Const,
...
//noinspection GoUnusedExportedFunction
func NewRandomMiopUniqueId(randomGenerator __goidl__.IRandomDataGenerator) *MiopUniqueId {
	//noinspection GoRedundantConversion
	return &MiopUniqueId{
		IdlObject: __goidl__.IdlObject{
			Id: MiopUniqueIdId_Const,
		...
		// "StructDclDefaultConstructorMemberDefaultValueService", MemberName: "Array", Type: "IdlOctet" Scope: "IdlOctetKind"
		Array: randomGenerator.OctetTypeValue(__reflect__.TypeOf((*MiopUniqueId)(nil)), "Array"),
	}
}
...
func (self *MiopUniqueId) ReadValue(stream __goidl__.IReadAny) error {
	...
	self.Array, err = __goidl__.IdlOctetHelper.Read(stream)
	if err != nil {
		return err
	}
	return nil
...
func (self *MiopUniqueId) Write(stream __goidl__.IWriteAny) error {
	...
	err = __goidl__.IdlOctetHelper.Write(stream, self.Array)
	if err != nil {
		return err
	}
	return nil
...
func NewDefaultMiopPacketHeader10() *MiopPacketHeader10 {
	...
	return &MiopPacketHeader10{
		...
		NumberOfPackets: 0,
		// "StructDclDefaultConstructorMemberDefaultValueService", MemberName: "Id", Type: "MIOP::UniqueId" Scope: "IdlStruct"
		Id: MiopUniqueId{
		IdlObject: __goidl__.IdlObject{
			Id: "ddd",
		},
...
func NewRandomMiopPacketHeader10(randomGenerator __goidl__.IRandomDataGenerator) *MiopPacketHeader10 {
	...
	return &MiopPacketHeader10{
		...
		// "StructDclDefaultConstructorMemberDefaultValueService", MemberName: "Array", Type: "IdlOctet" Scope: "IdlOctetKind"
		Array: randomGenerator.OctetTypeValue(__reflect__.TypeOf((*MiopPacketHeader10)(nil)), "Array"),
	},
	}
}
...
//noinspection GoUnusedExportedFunction
func NewDefaultMiopVersion() *MiopVersion {
	//noinspection GoRedundantConversion
	return &MiopVersion{
		GiopVersion: __goIdlGiop__.GiopVersion{
			IdlObject: __goidl__.IdlObject{
				Id: MiopVersionId_Const,
			},
...
//noinspection GoUnusedExportedFunction
func NewRandomMiopVersion(randomGenerator __goidl__.IRandomDataGenerator) *MiopVersion {
	//noinspection GoRedundantConversion
	return &MiopVersion{
		GiopVersion: __goIdlGiop__.GiopVersion{
			IdlObject: __goidl__.IdlObject{
			...
			// "StructDclDefaultConstructorMemberDefaultValueService", MemberName: "major", Type: "IdlOctet" Scope: "IdlOctetKind"
			Major: randomGenerator.OctetTypeValue(__reflect__.TypeOf((*MiopVersion)(nil)), "Major"),
			// "StructDclDefaultConstructorMemberDefaultValueService", MemberName: "minor", Type: "IdlOctet" Scope: "IdlOctetKind"
			Minor: randomGenerator.OctetTypeValue(__reflect__.TypeOf((*MiopVersion)(nil)), "Minor"),
		},
	}
}
...
func NewDefaultMiopUipmcProfileBody() *MiopUipmcProfileBody {
	...
	return &MiopUipmcProfileBody{
		...
		// "StructDclDefaultConstructorMemberDefaultValueService", MemberName: "miop_version", Type: "MIOP::Version" Scope: "IdlStruct"
...
func NewMiopUipmcProfileBody(
	...
	ThePort int16,
	//"StructDclAllParamsConstructorParamService"
	Components __goIdlIop__.IopTaggedComponentSeq) *MiopUipmcProfileBody {
	//noinspection GoRedundantConversion
	return &MiopUipmcProfileBody{
		IdlObject: __goidl__.IdlObject{
			Id: MiopUipmcProfileBodyId_Const,
...
func NewRandomMiopUipmcProfileBody(randomGenerator __goidl__.IRandomDataGenerator) *MiopUipmcProfileBody {
	...
	GiopVersion: __goIdlGiop__.GiopVersion{
		...
		// "StructDclDefaultConstructorMemberDefaultValueService", MemberName: "tag", Type: "IOP::ComponentId" Scope: "IdlTypedef"
		Tag: randomGenerator.UnsignedLongTypeValue(__reflect__.TypeOf((*MiopUipmcProfileBody)(nil)), "Tag"),
		// "StructDclDefaultConstructorMemberDefaultValueService", MemberName: "component_data", Type: "IOP::ComponentData" Scope: "IdlStruct"
		ComponentData: __goIdlIop__.IopComponentData{
	CorbaOctetSeq: __goIdlCorba__.CorbaOctetSeq{
		IdlObject: __goidl__.IdlObject{
		...
		// "StructDclDefaultConstructorMemberDefaultValueService", MemberName: "Array", Type: "IdlOctet" Scope: "IdlOctetKind"
		Array: randomGenerator.OctetTypeValue(__reflect__.TypeOf((*MiopUipmcProfileBody)(nil)), "Array"),
	},
	},
	},
	},
	...
	__goidl__.AddRegistration(
		__goidl__.NewRegistrationInformation(
			...
			func() __goidl__.IIdlObject {
				return NewDefaultMiopUniqueId()
			},
			func(generator __goidl__.IRandomDataGenerator) __goidl__.IIdlObject {
				return NewRandomMiopUniqueId(generator)
			},
